...
function Settings() {
  ...
  const groups: { title: string; items: Item[] }[] = [
    { title: "Account", items: [
      { icon: User, label: "Edit profile", sub: "Name, bio, avatar", to: "/profile/edit", glow: "#3b82f6" },
      {
        icon: Lock,
    ...
    { title: "Notifications", items: [
      { icon: Bell, label: "Push notifications", toggle: true, value: "push", glow: "#f97316" },
      { icon: MessageCircle, label: "Email digest", toggle: true, value: "email", glow: "#06b6d4" },
      { icon: Sparkles, label: "Inbox", sub: "View all activity", to: "/notifications", glow: "#eab308" },
    ]},
    { title: "Appearance", items: [
      { icon: Moon, label: "Dark mode", toggle: true, value: "dark", glow: "#6366f1" },
      {
        icon: Palette,
        label: "Accent color",
        value: "Ember",
    ...
    { title: "Experience", items: [
      { icon: Bell, label: "Sounds", toggle: true, value: "sounds", glow: "#06b6d4" },
      { icon: Sparkles, label: "Haptics", toggle: true, value: "haptics", glow: "#ec4899" },
      {
        icon: Download,
    ...
    { title: "About", items: [
      { icon: FileText, label: "Terms of Service", to: "/terms", glow: "#d97706" },
      { icon: ShieldCheck, label: "Privacy Policy", to: "/privacy", glow: "#10b981" },
      {
        icon: HelpCircle,
        label: "Help & support",
        glow: "#06b6d4",
